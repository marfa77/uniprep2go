...
export const SOURCE_NOTE = "Original UniPrep2Go local bank (Wave 2).";
...
/** Wave 2 niche banks: 4 topics × 15 questions = 60. */
export function buildBank(examSlug, topics, perTopic = 15) {
  /** @type {any[]} */
  const out = [];
