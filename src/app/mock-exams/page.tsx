      ...
      >
        ...
        <section className="mt-12 rounded-3xl border border-[#18140f]/10 bg-[#18140f]/5 p-5">
          ...
          <div className="mt-4 flex flex-wrap gap-4 text-sm font-medium text-[#1f3a5f]">
            ...
            <Link className="underline-offset-4 hover:underline" href="/mock-exams/leed-green-associate-readiness-check">
              LEED GA practice test
            </Link>
            <Link className="underline-offset-4 hover:underline" href="/mock-exams/pmp-readiness-check">
              PMP practice test
            </Link>
