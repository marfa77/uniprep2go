...
const mockDeckRepairPairSlugs: Array<{ mockSlug: string; deckSlug: string }> = [
  ...
  { mockSlug: "leben-in-deutschland-readiness-check", deckSlug: "leben-in-deutschland-prep2go-app" },
  { mockSlug: "naturalisation-francaise-readiness-check", deckSlug: "naturalisation-francaise-prep2go-app" },
  { mockSlug: "life-in-the-uk-readiness-check", deckSlug: "life-in-the-uk-prep2go-app" },
  { mockSlug: "canadian-citizenship-readiness-check", deckSlug: "canadian-citizenship-prep2go-app" },
  { mockSlug: "australian-citizenship-readiness-check", deckSlug: "australian-citizenship-prep2go-app" },
