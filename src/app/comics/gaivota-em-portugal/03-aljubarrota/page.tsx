...
const checkout = ep03.gumroadCheckoutUrl ?? gaivotaSeries.gumroadCheckoutUrl;
  ...
  return (
    <div className="min-h-screen bg-[#ebe4d8] text-[#0e0e0e]">
      ...
      <main className="mx-auto w-full max-w-3xl px-4 pb-16 pt-8 sm:px-8">
        ...
        <h1 className="mt-2 text-3xl font-semibold tracking-tight sm:text-4xl">Aljubarrota</h1>
        <p className="mt-2 text-base text-[#5c574e] sm:text-lg">
          Battle of Aljubarrota · 14 August 1385
        </p>

        <figure className="mt-8">
          <Image
            alt="Cover: Aljubarrota — Gaivota comic"
        ...
        <GaivotaEpisodeSeoSections episodeId="03-aljubarrota" />
      </main>
      <SiteFooter />
    </div>
  );
