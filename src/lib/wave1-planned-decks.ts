...
function plannedFromMock(config: (typeof wave1MockExamConfigs)[number]): PlannedDeck {
...
export const wave1PlannedDecks: PlannedDeck[] = wave1MockExamConfigs.map(plannedFromMock);
