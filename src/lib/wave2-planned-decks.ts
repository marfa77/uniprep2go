...
function plannedFromMock(config: (typeof wave2MockExamConfigs)[number]): PlannedDeck {
...
export const wave2PlannedDecks: PlannedDeck[] = wave2MockExamConfigs.map(plannedFromMock);
