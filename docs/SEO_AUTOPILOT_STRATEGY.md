...
**North star:** US organic + LLM referrals → free SIE/Series 7/63 mock completion → Anki/Gumroad purchase.  
**Primary market:** United States — FINRA securities ladder first.

## Signal rules

| Signal | Action |
|--------|--------|
| High-intent SIE / Series 7 / Series 63 query with weak title/meta | Rewrite title/meta/headline for CTR + mock CTA |
| FINRA mock without clear Anki CTA | Strengthen intro/FAQ → linked deck |
| Existing FINRA blog posts | Keep answer-first; CTA to SIE/7/63 mock + deck |
| Non-FINRA surfaces (USCIS, LEED, CDL, languages, etc.) | Frozen for weekly ships — keep pages live |
| Zero traffic but FINRA demand | Improve LLM citation surfaces for SIE/7/63 facts |

## Out of scope for weekly auto-edits

Pricing, Gumroad product IDs, auth, DB banks, layout CSS, inventing official pass rates, USCIS/building/language weekly ships.
